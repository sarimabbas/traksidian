...
Traksidian — an Obsidian plugin that syncs Trakt.tv data (watchlist, watch history, favorites, ratings) into vault notes with YAML frontmatter and customizable templates.
